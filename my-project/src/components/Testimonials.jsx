      ...
      <div className='relative max-w-7xl mx-auto items-center text-center'>
        <div className='text-center mb-10 max-w-[600px] mx-auto'>
          <motion.h2
            ...
            className='text-3xl md:text-4xl font-bold text-[#33cccc] text-center pb-5'>What Our Clients Say</motion.h2>

          <div>
            <Slider {...settings}>
              {testimonials.map((testimonial, index) => (
                <div key={index} className="flex flex-col gap-4 shadow-lg shadow-[#33cccc] py-8 px-6 rounded-xl bg-gray-950 relative">
                  <div className='mb-4'>

                    <img
                      src={testimonial.avatar}
                      alt={testimonial.name}
                      className="w-20 h-20 border-2 border-[#33cccc] rounded-full mx-auto mb-4"
                    />
